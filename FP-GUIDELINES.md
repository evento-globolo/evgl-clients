...
check was introduced: **6 findings across 9 files
and 154 lines**. CI compares against that budget and fails only when a
...
| `TS006` | 2 | warn | typed errors | `throw` as control flow |
