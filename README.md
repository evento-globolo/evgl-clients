...
Polyglot client SDKs for **Evento Globolo**. The repository is intentionally transport-oriented: generated and handwritten clients share one endpoint contract while each language keeps idiomatic authentication, retries, and error handling.
...
```js
import { createClient } from '@evento-globolo/evgl-clients';
